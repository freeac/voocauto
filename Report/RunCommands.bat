...
java -jar CompressFile.jar 1 "C:\temp\report\Report_APi_%YYYY%-%MM%-%DD%_%HH%-%Min%-%Sec%.zip" "%cd%/VOOC_Report_Automation_%YYYY%-%MM%-%DD%_%HH%-%Min%-%Sec%"
...
java -jar SendMail.jar "C:\temp\report\Report_APi_%YYYY%-%MM%-%DD%_%HH%-%Min%-%Sec%.zip" nhanvuong@vooc.vn
